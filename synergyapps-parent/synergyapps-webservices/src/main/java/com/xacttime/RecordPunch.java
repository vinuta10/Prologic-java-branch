 ...
 *         &lt;element name="punch" type="{http://xacttime.com/}PunchData" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "RecordPunch")
public class RecordPunch {

    @XmlElement(required = true)
    protected String webServicesKey;
    protected int terminalId;
    protected PunchData punch;
     ...
     *     
     */
    public void setPunch(PunchData value) {
        this.punch = value;
    }
