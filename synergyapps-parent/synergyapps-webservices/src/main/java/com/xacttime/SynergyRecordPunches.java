 ...
 *         &lt;element name="punches" type="{http://xacttime.com/}ArrayOfSynergyPunchData" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "SynergyRecordPunches")
public class SynergyRecordPunches {

    @XmlElement(required = true)
    protected String webServicesKey;
    protected int terminalId;
    protected ArrayOfSynergyPunchData punches;
     ...
     * @return
     *     possible object is
     *     {@link ArrayOfSynergyPunchData }
     *     
     */
    public ArrayOfSynergyPunchData getPunches() {
        return punches;
    }
     ...
     *     
     */
    public void setPunches(ArrayOfSynergyPunchData value) {
        this.punches = value;
    }
