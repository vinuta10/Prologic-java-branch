...
public class SynergyEventController implements SynergyStatusListener {
	...
	public void initialize()
	{
		...
		if(null != MainWindow.getmSplash()){
			MainWindow.renderSplashFrame(MainWindow.getmSplash().createGraphics(), 2);
